...
namespace OneDayProjectMvc.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(User user, LoginViewModel model)
        {
            IQueryable<Basket> basketQueryable = null;
            ...
            string password = Request.Form["Password"];
                ...
                user = userServiceClient.GetUserByEmailAddress(username);
                int userId = user.UserId;

                if (db.Baskets.Any(u => u.UserId == userId) == false)
                {
